...
*/
unsafe fn generate_batch(mut target: *mut i16,
                                    mut count: i32,
                                    mut source1: *mut i16,
                                    mut weight1: i32,
                                    mut source2: *mut i16,
...
*/
unsafe fn free_memory_block(mut block: i32) {
...
*/
unsafe fn eval_adjustment(mut disc_adjust: f64,
                                     mut edge_adjust: f64,
...
*/
unsafe fn remove_specific_coeffs(mut phase: i32) {
