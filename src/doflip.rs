...
static mut board_region: [libc::c_char; 100] =
    [0 as libc::c_int as libc::c_char, 0 as libc::c_int as libc::c_char,
     ...
     1 as libc::c_int as libc::c_char, 2 as libc::c_int as libc::c_char,
     ...
     5 as libc::c_int as libc::c_char, 6 as libc::c_int as libc::c_char,
     6 as libc::c_int as libc::c_char, 0 as libc::c_int as libc::c_char,
     0 as libc::c_int as libc::c_char, 7 as libc::c_int as libc::c_char,
     7 as libc::c_int as libc::c_char, 8 as libc::c_int as libc::c_char,
     ...
     9 as libc::c_int as libc::c_char, 0 as libc::c_int as libc::c_char,
     0 as libc::c_int as libc::c_char, 7 as libc::c_int as libc::c_char,
     7 as libc::c_int as libc::c_char, 8 as libc::c_int as libc::c_char,
     8 as libc::c_int as libc::c_char, 8 as libc::c_int as libc::c_char,
     8 as libc::c_int as libc::c_char, 9 as libc::c_int as libc::c_char,
...
pub unsafe extern "C" fn DoFlips_no_hash(mut sqnum: libc::c_int,
 ...
 -> libc::c_int {
    ...
    let mut old_flip_stack = 0 as *mut *mut libc::c_int;
    let mut t_flip_stack = 0 as *mut *mut libc::c_int;
    t_flip_stack = flip_stack;
    old_flip_stack = t_flip_stack;
    sq = &mut *board.as_mut_ptr().offset(sqnum as isize) as *mut libc::c_int;
    match board_region[sqnum as usize] as libc::c_int {
        1 => {
            let mut pt = sq.offset(1 as libc::c_int as isize);
            if *pt == opp_color {
            ...
            let mut pt_0 = sq.offset(11 as libc::c_int as isize);
            if *pt_0 == opp_color {
                pt_0 = pt_0.offset(11 as libc::c_int as isize);
                if *pt_0 == opp_color {
                    pt_0 = pt_0.offset(11 as libc::c_int as isize);
                    if *pt_0 == opp_color {
                        pt_0 = pt_0.offset(11 as libc::c_int as isize);
                        if *pt_0 == opp_color {
                            ...
                            if *pt_0 == opp_color {
                                pt_0 =
                                    pt_0.offset(11 as libc::c_int as isize);
                                if *pt_0 == opp_color {
                                    pt_0 =
                                        pt_0.offset(11 as libc::c_int as
                                                        isize)
                                }
                            }
                        }
            ...
            let mut pt_1 = sq.offset(10 as libc::c_int as isize);
            if *pt_1 == opp_color {
                pt_1 = pt_1.offset(10 as libc::c_int as isize);
                if *pt_1 == opp_color {
                    pt_1 = pt_1.offset(10 as libc::c_int as isize);
                    if *pt_1 == opp_color {
                        pt_1 = pt_1.offset(10 as libc::c_int as isize);
                        if *pt_1 == opp_color {
                            ...
                            if *pt_1 == opp_color {
                                pt_1 =
                                    pt_1.offset(10 as libc::c_int as isize);
                                if *pt_1 == opp_color {
                                    pt_1 =
                                        pt_1.offset(10 as libc::c_int as
                                                        isize)
                                }
                            }
                        }
        ...
        2 => {
            let mut pt_2 = sq.offset(1 as libc::c_int as isize);
            if *pt_2 == opp_color {
                pt_2 = pt_2.offset(1 as libc::c_int as isize);
                if *pt_2 == opp_color {
                    pt_2 = pt_2.offset(1 as libc::c_int as isize);
                    if *pt_2 == opp_color {
                        pt_2 = pt_2.offset(1 as libc::c_int as isize);
            ...
            let mut pt_3 = sq.offset(11 as libc::c_int as isize);
            if *pt_3 == opp_color {
                pt_3 = pt_3.offset(11 as libc::c_int as isize);
                if *pt_3 == opp_color {
                    pt_3 = pt_3.offset(11 as libc::c_int as isize);
                    if *pt_3 == opp_color {
                        pt_3 = pt_3.offset(11 as libc::c_int as isize);
            ...
            let mut pt_4 = sq.offset(10 as libc::c_int as isize);
            if *pt_4 == opp_color {
                pt_4 = pt_4.offset(10 as libc::c_int as isize);
                if *pt_4 == opp_color {
                    pt_4 = pt_4.offset(10 as libc::c_int as isize);
                    if *pt_4 == opp_color {
                        pt_4 = pt_4.offset(10 as libc::c_int as isize);
                        if *pt_4 == opp_color {
                            ...
                            if *pt_4 == opp_color {
                                pt_4 =
                                    pt_4.offset(10 as libc::c_int as isize);
                                if *pt_4 == opp_color {
                                    pt_4 =
                                        pt_4.offset(10 as libc::c_int as
                                                        isize)
                                }
                            }
                        }
            ...
            let mut pt_5 = sq.offset(9 as libc::c_int as isize);
            if *pt_5 == opp_color {
                pt_5 = pt_5.offset(9 as libc::c_int as isize);
                if *pt_5 == opp_color {
                    pt_5 = pt_5.offset(9 as libc::c_int as isize);
                    if *pt_5 == opp_color {
                        pt_5 = pt_5.offset(9 as libc::c_int as isize);
            ...
            let mut pt_6 = sq.offset(-(1 as libc::c_int) as isize);
            if *pt_6 == opp_color {
                pt_6 = pt_6.offset(-(1 as libc::c_int) as isize);
                if *pt_6 == opp_color {
                    pt_6 = pt_6.offset(-(1 as libc::c_int) as isize);
                    if *pt_6 == opp_color {
                        pt_6 = pt_6.offset(-(1 as libc::c_int) as isize);
        ...
        3 => {
            let mut pt_7 = sq.offset(10 as libc::c_int as isize);
            if *pt_7 == opp_color {
                pt_7 = pt_7.offset(10 as libc::c_int as isize);
                if *pt_7 == opp_color {
                    pt_7 = pt_7.offset(10 as libc::c_int as isize);
                    if *pt_7 == opp_color {
                        pt_7 = pt_7.offset(10 as libc::c_int as isize);
                        if *pt_7 == opp_color {
                            ...
                            if *pt_7 == opp_color {
                                pt_7 =
                                    pt_7.offset(10 as libc::c_int as isize);
                                if *pt_7 == opp_color {
                                    pt_7 =
                                        pt_7.offset(10 as libc::c_int as
                                                        isize)
                                }
                            }
                        }
            ...
            let mut pt_8 = sq.offset(9 as libc::c_int as isize);
            if *pt_8 == opp_color {
                pt_8 = pt_8.offset(9 as libc::c_int as isize);
                if *pt_8 == opp_color {
                    pt_8 = pt_8.offset(9 as libc::c_int as isize);
                    if *pt_8 == opp_color {
                        pt_8 = pt_8.offset(9 as libc::c_int as isize);
                        if *pt_8 == opp_color {
                            ...
                            if *pt_8 == opp_color {
                                ...
                                if *pt_8 == opp_color {
                                    pt_8 =
                                        pt_8.offset(9 as libc::c_int as isize)
                                }
                            }
                        }
                    }
            ...
            let mut pt_9 = sq.offset(-(1 as libc::c_int) as isize);
            if *pt_9 == opp_color {
                pt_9 = pt_9.offset(-(1 as libc::c_int) as isize);
                if *pt_9 == opp_color {
                    pt_9 = pt_9.offset(-(1 as libc::c_int) as isize);
                    if *pt_9 == opp_color {
                        pt_9 = pt_9.offset(-(1 as libc::c_int) as isize);
                        if *pt_9 == opp_color {
                            ...
                            if *pt_9 == opp_color {
                                pt_9 =
                                    pt_9.offset(-(1 as libc::c_int) as isize);
                                if *pt_9 == opp_color {
                                    pt_9 =
                                        pt_9.offset(-(1 as libc::c_int) as
                                                        isize)
                                }
                            }
                        }
        ...
        4 => {
            let mut pt_10 = sq.offset(-(10 as libc::c_int) as isize);
            if *pt_10 == opp_color {
                pt_10 = pt_10.offset(-(10 as libc::c_int) as isize);
                if *pt_10 == opp_color {
                    pt_10 = pt_10.offset(-(10 as libc::c_int) as isize);
                    if *pt_10 == opp_color {
                        pt_10 = pt_10.offset(-(10 as libc::c_int) as isize);
                        if *pt_10 == opp_color {
                            pt_10 =
                                pt_10.offset(-(10 as libc::c_int) as isize)
                        }
                    }
                }
                if *pt_10 == color {
            ...
            let mut pt_11 = sq.offset(-(9 as libc::c_int) as isize);
            if *pt_11 == opp_color {
                pt_11 = pt_11.offset(-(9 as libc::c_int) as isize);
                if *pt_11 == opp_color {
                    pt_11 = pt_11.offset(-(9 as libc::c_int) as isize);
                    if *pt_11 == opp_color {
                        pt_11 = pt_11.offset(-(9 as libc::c_int) as isize);
            ...
            let mut pt_12 = sq.offset(1 as libc::c_int as isize);
            if *pt_12 == opp_color {
                pt_12 = pt_12.offset(1 as libc::c_int as isize);
                if *pt_12 == opp_color {
                    pt_12 = pt_12.offset(1 as libc::c_int as isize);
                    if *pt_12 == opp_color {
                        pt_12 = pt_12.offset(1 as libc::c_int as isize);
                        if *pt_12 == opp_color {
                            ...
                            if *pt_12 == opp_color {
                                pt_12 =
                                    pt_12.offset(1 as libc::c_int as isize);
                                if *pt_12 == opp_color {
                                    pt_12 =
                                        pt_12.offset(1 as libc::c_int as
                                                         isize)
                                }
                            }
                        }
            ...
            let mut pt_13 = sq.offset(11 as libc::c_int as isize);
            if *pt_13 == opp_color {
                pt_13 = pt_13.offset(11 as libc::c_int as isize);
                if *pt_13 == opp_color {
                    pt_13 = pt_13.offset(11 as libc::c_int as isize);
                    if *pt_13 == opp_color {
                        pt_13 = pt_13.offset(11 as libc::c_int as isize);
            ...
            let mut pt_14 = sq.offset(10 as libc::c_int as isize);
            if *pt_14 == opp_color {
                pt_14 = pt_14.offset(10 as libc::c_int as isize);
                if *pt_14 == opp_color {
                    pt_14 = pt_14.offset(10 as libc::c_int as isize);
                    if *pt_14 == opp_color {
                        pt_14 = pt_14.offset(10 as libc::c_int as isize);
        ...
        5 => {
            let mut pt_15 = sq.offset(-(11 as libc::c_int) as isize);
            if *pt_15 == opp_color {
                pt_15 = pt_15.offset(-(11 as libc::c_int) as isize);
                if *pt_15 == opp_color {
                    pt_15 = pt_15.offset(-(11 as libc::c_int) as isize);
                    if *pt_15 == opp_color {
                        pt_15 = pt_15.offset(-(11 as libc::c_int) as isize);
                        if *pt_15 == opp_color {
                            pt_15 =
                                pt_15.offset(-(11 as libc::c_int) as isize)
                        }
                    }
                }
                if *pt_15 == color {
            ...
            let mut pt_16 = sq.offset(-(10 as libc::c_int) as isize);
            if *pt_16 == opp_color {
                pt_16 = pt_16.offset(-(10 as libc::c_int) as isize);
                if *pt_16 == opp_color {
                    pt_16 = pt_16.offset(-(10 as libc::c_int) as isize);
                    if *pt_16 == opp_color {
                        pt_16 = pt_16.offset(-(10 as libc::c_int) as isize);
                        if *pt_16 == opp_color {
                            pt_16 =
                                pt_16.offset(-(10 as libc::c_int) as isize)
                        }
                    }
                }
                if *pt_16 == color {
            ...
            let mut pt_17 = sq.offset(-(9 as libc::c_int) as isize);
            if *pt_17 == opp_color {
                pt_17 = pt_17.offset(-(9 as libc::c_int) as isize);
                if *pt_17 == opp_color {
                    pt_17 = pt_17.offset(-(9 as libc::c_int) as isize);
                    if *pt_17 == opp_color {
                        pt_17 = pt_17.offset(-(9 as libc::c_int) as isize);
            ...
            let mut pt_18 = sq.offset(1 as libc::c_int as isize);
            if *pt_18 == opp_color {
                pt_18 = pt_18.offset(1 as libc::c_int as isize);
                if *pt_18 == opp_color {
                    pt_18 = pt_18.offset(1 as libc::c_int as isize);
                    if *pt_18 == opp_color {
                        pt_18 = pt_18.offset(1 as libc::c_int as isize);
            ...
            let mut pt_19 = sq.offset(11 as libc::c_int as isize);
            if *pt_19 == opp_color {
                pt_19 = pt_19.offset(11 as libc::c_int as isize);
                if *pt_19 == opp_color {
                    pt_19 = pt_19.offset(11 as libc::c_int as isize);
                    if *pt_19 == opp_color {
                        pt_19 = pt_19.offset(11 as libc::c_int as isize);
            ...
            let mut pt_20 = sq.offset(10 as libc::c_int as isize);
            if *pt_20 == opp_color {
                pt_20 = pt_20.offset(10 as libc::c_int as isize);
                if *pt_20 == opp_color {
                    pt_20 = pt_20.offset(10 as libc::c_int as isize);
                    if *pt_20 == opp_color {
                        pt_20 = pt_20.offset(10 as libc::c_int as isize);
            ...
            let mut pt_21 = sq.offset(9 as libc::c_int as isize);
            if *pt_21 == opp_color {
                pt_21 = pt_21.offset(9 as libc::c_int as isize);
                if *pt_21 == opp_color {
                    pt_21 = pt_21.offset(9 as libc::c_int as isize);
                    if *pt_21 == opp_color {
                        pt_21 = pt_21.offset(9 as libc::c_int as isize);
            ...
            let mut pt_22 = sq.offset(-(1 as libc::c_int) as isize);
            if *pt_22 == opp_color {
                pt_22 = pt_22.offset(-(1 as libc::c_int) as isize);
                if *pt_22 == opp_color {
                    pt_22 = pt_22.offset(-(1 as libc::c_int) as isize);
                    if *pt_22 == opp_color {
                        pt_22 = pt_22.offset(-(1 as libc::c_int) as isize);
        ...
        6 => {
            let mut pt_23 = sq.offset(-(10 as libc::c_int) as isize);
            if *pt_23 == opp_color {
                pt_23 = pt_23.offset(-(10 as libc::c_int) as isize);
                if *pt_23 == opp_color {
                    pt_23 = pt_23.offset(-(10 as libc::c_int) as isize);
                    if *pt_23 == opp_color {
                        pt_23 = pt_23.offset(-(10 as libc::c_int) as isize);
                        if *pt_23 == opp_color {
                            pt_23 =
                                pt_23.offset(-(10 as libc::c_int) as isize)
                        }
                    }
                }
                if *pt_23 == color {
            ...
            let mut pt_24 = sq.offset(-(11 as libc::c_int) as isize);
            if *pt_24 == opp_color {
                pt_24 = pt_24.offset(-(11 as libc::c_int) as isize);
                if *pt_24 == opp_color {
                    pt_24 = pt_24.offset(-(11 as libc::c_int) as isize);
                    if *pt_24 == opp_color {
                        pt_24 = pt_24.offset(-(11 as libc::c_int) as isize);
                        if *pt_24 == opp_color {
                            pt_24 =
                                pt_24.offset(-(11 as libc::c_int) as isize)
                        }
                    }
                }
                if *pt_24 == color {
            ...
            let mut pt_25 = sq.offset(-(1 as libc::c_int) as isize);
            if *pt_25 == opp_color {
                pt_25 = pt_25.offset(-(1 as libc::c_int) as isize);
                if *pt_25 == opp_color {
                    pt_25 = pt_25.offset(-(1 as libc::c_int) as isize);
                    if *pt_25 == opp_color {
                        pt_25 = pt_25.offset(-(1 as libc::c_int) as isize);
                        if *pt_25 == opp_color {
                            pt_25 =
                                pt_25.offset(-(1 as libc::c_int) as isize);
                            if *pt_25 == opp_color {
                                pt_25 =
                                    pt_25.offset(-(1 as libc::c_int) as
                                                     isize);
                                if *pt_25 == opp_color {
                                    pt_25 =
                                        pt_25.offset(-(1 as libc::c_int) as
            ...
            let mut pt_26 = sq.offset(9 as libc::c_int as isize);
            if *pt_26 == opp_color {
                pt_26 = pt_26.offset(9 as libc::c_int as isize);
                if *pt_26 == opp_color {
                    pt_26 = pt_26.offset(9 as libc::c_int as isize);
                    if *pt_26 == opp_color {
                        pt_26 = pt_26.offset(9 as libc::c_int as isize);
            ...
            let mut pt_27 = sq.offset(10 as libc::c_int as isize);
            if *pt_27 == opp_color {
                pt_27 = pt_27.offset(10 as libc::c_int as isize);
                if *pt_27 == opp_color {
                    pt_27 = pt_27.offset(10 as libc::c_int as isize);
                    if *pt_27 == opp_color {
                        pt_27 = pt_27.offset(10 as libc::c_int as isize);
        ...
        7 => {
            let mut pt_28 = sq.offset(-(10 as libc::c_int) as isize);
            if *pt_28 == opp_color {
                pt_28 = pt_28.offset(-(10 as libc::c_int) as isize);
                if *pt_28 == opp_color {
                    pt_28 = pt_28.offset(-(10 as libc::c_int) as isize);
                    if *pt_28 == opp_color {
                        pt_28 = pt_28.offset(-(10 as libc::c_int) as isize);
                        if *pt_28 == opp_color {
                            pt_28 =
                                pt_28.offset(-(10 as libc::c_int) as isize);
                            if *pt_28 == opp_color {
                                pt_28 =
                                    pt_28.offset(-(10 as libc::c_int) as
                                                     isize);
                                if *pt_28 == opp_color {
                                    pt_28 =
                                        pt_28.offset(-(10 as libc::c_int) as
            ...
            let mut pt_29 = sq.offset(-(9 as libc::c_int) as isize);
            if *pt_29 == opp_color {
                pt_29 = pt_29.offset(-(9 as libc::c_int) as isize);
                if *pt_29 == opp_color {
                    pt_29 = pt_29.offset(-(9 as libc::c_int) as isize);
                    if *pt_29 == opp_color {
                        pt_29 = pt_29.offset(-(9 as libc::c_int) as isize);
                        if *pt_29 == opp_color {
                            pt_29 =
                                pt_29.offset(-(9 as libc::c_int) as isize);
                            if *pt_29 == opp_color {
                                pt_29 =
                                    pt_29.offset(-(9 as libc::c_int) as
                                                     isize);
                                if *pt_29 == opp_color {
                                    pt_29 =
                                        pt_29.offset(-(9 as libc::c_int) as
            ...
            let mut pt_30 = sq.offset(1 as libc::c_int as isize);
            if *pt_30 == opp_color {
                pt_30 = pt_30.offset(1 as libc::c_int as isize);
                if *pt_30 == opp_color {
                    pt_30 = pt_30.offset(1 as libc::c_int as isize);
                    if *pt_30 == opp_color {
                        pt_30 = pt_30.offset(1 as libc::c_int as isize);
                        if *pt_30 == opp_color {
                            ...
                            if *pt_30 == opp_color {
                                pt_30 =
                                    pt_30.offset(1 as libc::c_int as isize);
                                if *pt_30 == opp_color {
                                    pt_30 =
                                        pt_30.offset(1 as libc::c_int as
                                                         isize)
                                }
                            }
                        }
        ...
        8 => {
            let mut pt_31 = sq.offset(-(1 as libc::c_int) as isize);
            if *pt_31 == opp_color {
                pt_31 = pt_31.offset(-(1 as libc::c_int) as isize);
                if *pt_31 == opp_color {
                    pt_31 = pt_31.offset(-(1 as libc::c_int) as isize);
                    if *pt_31 == opp_color {
                        pt_31 = pt_31.offset(-(1 as libc::c_int) as isize);
            ...
            let mut pt_32 = sq.offset(-(11 as libc::c_int) as isize);
            if *pt_32 == opp_color {
                pt_32 = pt_32.offset(-(11 as libc::c_int) as isize);
                if *pt_32 == opp_color {
                    pt_32 = pt_32.offset(-(11 as libc::c_int) as isize);
                    if *pt_32 == opp_color {
                        pt_32 = pt_32.offset(-(11 as libc::c_int) as isize);
                        if *pt_32 == opp_color {
                            pt_32 =
                                pt_32.offset(-(11 as libc::c_int) as isize)
                        }
                    }
                }
                if *pt_32 == color {
            ...
            let mut pt_33 = sq.offset(-(10 as libc::c_int) as isize);
            if *pt_33 == opp_color {
                pt_33 = pt_33.offset(-(10 as libc::c_int) as isize);
                if *pt_33 == opp_color {
                    pt_33 = pt_33.offset(-(10 as libc::c_int) as isize);
                    if *pt_33 == opp_color {
                        pt_33 = pt_33.offset(-(10 as libc::c_int) as isize);
                        if *pt_33 == opp_color {
                            pt_33 =
                                pt_33.offset(-(10 as libc::c_int) as isize);
                            if *pt_33 == opp_color {
                                pt_33 =
                                    pt_33.offset(-(10 as libc::c_int) as
                                                     isize);
                                if *pt_33 == opp_color {
                                    pt_33 =
                                        pt_33.offset(-(10 as libc::c_int) as
            ...
            let mut pt_34 = sq.offset(-(9 as libc::c_int) as isize);
            if *pt_34 == opp_color {
                pt_34 = pt_34.offset(-(9 as libc::c_int) as isize);
                if *pt_34 == opp_color {
                    pt_34 = pt_34.offset(-(9 as libc::c_int) as isize);
                    if *pt_34 == opp_color {
                        pt_34 = pt_34.offset(-(9 as libc::c_int) as isize);
            ...
            let mut pt_35 = sq.offset(1 as libc::c_int as isize);
            if *pt_35 == opp_color {
                pt_35 = pt_35.offset(1 as libc::c_int as isize);
                if *pt_35 == opp_color {
                    pt_35 = pt_35.offset(1 as libc::c_int as isize);
                    if *pt_35 == opp_color {
                        pt_35 = pt_35.offset(1 as libc::c_int as isize);
        ...
        9 => {
            let mut pt_36 = sq.offset(-(10 as libc::c_int) as isize);
            if *pt_36 == opp_color {
                pt_36 = pt_36.offset(-(10 as libc::c_int) as isize);
                if *pt_36 == opp_color {
                    pt_36 = pt_36.offset(-(10 as libc::c_int) as isize);
                    if *pt_36 == opp_color {
                        pt_36 = pt_36.offset(-(10 as libc::c_int) as isize);
                        if *pt_36 == opp_color {
                            pt_36 =
                                pt_36.offset(-(10 as libc::c_int) as isize);
                            if *pt_36 == opp_color {
                                pt_36 =
                                    pt_36.offset(-(10 as libc::c_int) as
                                                     isize);
                                if *pt_36 == opp_color {
                                    pt_36 =
                                        pt_36.offset(-(10 as libc::c_int) as
            ...
            let mut pt_37 = sq.offset(-(11 as libc::c_int) as isize);
            if *pt_37 == opp_color {
                pt_37 = pt_37.offset(-(11 as libc::c_int) as isize);
                if *pt_37 == opp_color {
                    pt_37 = pt_37.offset(-(11 as libc::c_int) as isize);
                    if *pt_37 == opp_color {
                        pt_37 = pt_37.offset(-(11 as libc::c_int) as isize);
                        if *pt_37 == opp_color {
                            pt_37 =
                                pt_37.offset(-(11 as libc::c_int) as isize);
                            if *pt_37 == opp_color {
                                pt_37 =
                                    pt_37.offset(-(11 as libc::c_int) as
                                                     isize);
                                if *pt_37 == opp_color {
                                    pt_37 =
                                        pt_37.offset(-(11 as libc::c_int) as
            ...
            let mut pt_38 = sq.offset(-(1 as libc::c_int) as isize);
            if *pt_38 == opp_color {
                pt_38 = pt_38.offset(-(1 as libc::c_int) as isize);
                if *pt_38 == opp_color {
                    pt_38 = pt_38.offset(-(1 as libc::c_int) as isize);
                    if *pt_38 == opp_color {
                        pt_38 = pt_38.offset(-(1 as libc::c_int) as isize);
                        if *pt_38 == opp_color {
                            pt_38 =
                                pt_38.offset(-(1 as libc::c_int) as isize);
                            if *pt_38 == opp_color {
                                pt_38 =
                                    pt_38.offset(-(1 as libc::c_int) as
                                                     isize);
                                if *pt_38 == opp_color {
                                    pt_38 =
                                        pt_38.offset(-(1 as libc::c_int) as
    ...
    return t_flip_stack.wrapping_offset_from(old_flip_stack) as libc::c_long
               as libc::c_int;
}
/*
   doflip.h
...
pub unsafe extern "C" fn DoFlips_hash(mut sqnum: libc::c_int,
    ...
    let mut old_flip_stack = 0 as *mut *mut libc::c_int;
    let mut t_flip_stack = 0 as *mut *mut libc::c_int;
    let mut t_hash_update1: libc::c_int = 0;
    let mut t_hash_update2: libc::c_int = 0;
    t_flip_stack = flip_stack;
    old_flip_stack = t_flip_stack;
    t_hash_update2 = 0 as libc::c_int;
        ...
        1 => {
            ...
            if *pt == opp_color {
                ...
                if *pt == color {
                    ...
                    loop  {
                        t_hash_update1 =
                            (t_hash_update1 as libc::c_uint ^
                                 hash_flip1[pt.wrapping_offset_from(board.as_mut_ptr())
                                                as libc::c_long as usize]) as
                                libc::c_int;
                        t_hash_update2 =
                            (t_hash_update2 as libc::c_uint ^
    ...
    hash_update1 = t_hash_update1 as libc::c_uint;
    hash_update2 = t_hash_update2 as libc::c_uint;
    flip_stack = t_flip_stack;
    return t_flip_stack.wrapping_offset_from(old_flip_stack) as libc::c_long
               as libc::c_int;
}
